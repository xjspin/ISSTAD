...
The code runs on Windows or Linux systems with file systems on NTFS disks. Otherwise, the results may degrade, especially for the localization result of MVTec AD.
